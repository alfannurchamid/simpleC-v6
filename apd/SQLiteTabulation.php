...
class SQLiteTabulation
{
  ...
  public function insertRiwayatKet(
    $asalId,
    $persil,
    $kelas,
    $luas,
    ...
    $sql =
      "INSERT INTO riwayat(asal_id, persil, kelas, luas, sebab, dari, ke, tgl, ket) VALUES(:asal_id, :persil, :kelas, :luas, :sebab, :dari, :ke, :tgl, :ket)";
