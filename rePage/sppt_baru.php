<div class="row">
                ...
                <h1 style="text-align:center; text-decoration:underline"><strong><?php if(!isset($_post['semua'])){ 
                                                                                                                    if(isset($th)) {echo"Sppt Baru tahun : "."$th"; $nul = "Tidak Ada Sppt Baru di Tahun "."$th";}
                                                                                                                    else{echo"Sppt Baru di Semua Tahun"; $nul = "Tidak Ada Sppt Baru Semua Tahun";
                                                                                                                }} ?></strong></h1>
                 
                <form action='base.php?page=spptbar' method="POST">
                    <h2 >pilih tahun :  <input type="text" name="tahun"> <label class="radio-inline" style="font-weight: bold; font-size: 18px; margin-left:30px;">
                        ...
                        <button type="submit" class="btn btn-default" style="background:blue; color:white;"><strong>Tampilkan</strong></button>
                    </h2>
