...
<form id="WAform">
    <div class="col-md-4" style="margin-top: 50px">
        <div class="panel panel-info">
            <div class="panel-heading" style="font-size: 21px; padding: 5px;">Nomor C</div>
            <div class="panel-body" style="padding:0">
                <input style="padding:10px" class="inputCell itemReq" type="text" placeholder="Nomor C" id="wNoC">
            </div>
            <div class="panel-heading" style="font-size: 21px; padding: 5px;">Nama</div>
            <div class="panel-body" style="padding:0">
                <input style="padding:10px" class="inputCell itemReq" type="text" placeholder="Nama" id="wNama" onkeyup="this.value = this.value.toUpperCase();">
            </div>
            <div class="panel-heading" style="font-size: 21px; padding: 5px;">Alamat</div>
            <div class="panel-body" style="padding:0">
                <input style="padding:10px" class="inputCell itemReq" type="text" placeholder="Alamat" id="wAlamat" onkeyup="this.value=toTitleCase(this.value)">
            </div>
        </div>
        ...
        <form class="form-file" id="formDatabase" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <h4 style="margin-top:20px; margin-bottom:-10px" id="fileName2">Belum Ada File Yang Dipilih</h4>
                </div>
...
<script>
    ...
    function submited(sbm) {
        ...
        var wNoC = document.getElementById('wNoC').value;
        var wNama = document.getElementById('wNama').value;
        var wAlamat = document.getElementById('wAlamat').value;
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response == 0) {
                    ...
                    $('#foot').html('<button type="button" class="btn btn-info" style="float:left;" data-dismiss="modal"><strong>Tambah Data Lagi</strong></button><button type="button" class="btn btn-success" id="showMe" onclick="window.location=\'base.php?page=profiling&q=' + wNoC + '&r=1\'"><strong>Lihat Profil Data</strong></button>');
                    reseter();
                } else {
