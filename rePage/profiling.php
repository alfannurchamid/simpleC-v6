            ...
            <div class="col-md-9" style="float:right">
                ...
                <div class="tab-content" id="children">
                        ...
                        <table class="table table-bordered table-striped" id="tabAset">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    ?>
                                    <tr>
                                        <td style="text-align:center" colspan=4>Tidak Ada Catatan Aset</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered table-striped" id="tabAsetPet">
                            ...
                            <tbody>
                                ...
                                if (count($petikan) > 0) {
                                    ...
                                    ?>
                                    <tr>
                                        <td style="text-align:center" colspan=6>Tidak Ada Catatan Petikan</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div class="tab-pane" id="d" style="margin-top:-10.5px; margin-bottom:-30px">
                        ...
                        <!--<embed src="domba.php?q=<?php //echo $q 
                                                    ?>" type="application/pdf" height="99%" width="100%" />-->
                    </div>
